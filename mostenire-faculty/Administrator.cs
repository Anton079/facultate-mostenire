...
namespace mostenire_faculty
{
    ...
    {
        public Administrator(int id, string firstName, string lastName, string email, string password, int phoneNumber, string type, int hourOfService, int lenghtOfService, int salary) : base(id, firstName, lastName, email, password, phoneNumber, type, hourOfService, lenghtOfService, salary)
        {
